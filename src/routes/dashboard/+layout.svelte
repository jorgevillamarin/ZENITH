...
<div class="flex flex-col md:flex-row min-h-screen font-sans antialiased bg-[#f9f9f9]">
    ...
    ">
        ...
        <nav class="flex-grow flex flex-col space-y-4">
            ...
            <a href="#reporte" on:click={() => isMenuOpen = false} class="flex items-center space-x-3 text-lg p-3 rounded-lg text-gray-300 hover:bg-[#2a2a4e] hover:text-white transition-colors">
                <span>📈</span> <span class="text-base md:text-lg">Reporte</span>
            </a>
        </nav>
    </aside>
